...
var CmImage = (_temp2 = _class = function (_BodyComponent) {
    (0, _inherits3.default)(CmImage, _BodyComponent);
    ...
    function CmImage() {
        ...
        (0, _classCallCheck3.default)(this, CmImage);

        for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
        }

        return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = CmImage.__proto__ || (0, _getPrototypeOf2.default)(CmImage)).call.apply(_ref, [this].concat(args))), _this), _this.headStyle = function (breakpoint) {
            return '\n      @media only screen and (max-width:' + breakpoint + ') {\n        table.full-width-mobile { width: 100% !important; }\n        td.full-width-mobile { width: auto !important; }\n      }\n    ';
        }, _temp), (0, _possibleConstructorReturn3.default)(_this, _ret);
    }

    (0, _createClass3.default)(CmImage, [{
        key: 'getStyles',
