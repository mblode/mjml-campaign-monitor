...
var CmWebversion = (_temp = _class = function (_MjText) {
    (0, _inherits3.default)(CmWebversion, _MjText);

    function CmWebversion() {
        (0, _classCallCheck3.default)(this, CmWebversion);
        return (0, _possibleConstructorReturn3.default)(this, (CmWebversion.__proto__ || (0, _getPrototypeOf2.default)(CmWebversion)).apply(this, arguments));
    }

    (0, _createClass3.default)(CmWebversion, [{
        key: 'renderContent',
